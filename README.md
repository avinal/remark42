...
| notify.user_types       | NOTIFY_USERS            | none                     | type of user notifications (email)              |
...
| notify.type        | notify.user_types, notify.admin_types | NOTIFY_TYPE | NOTIFY_ADMIN_TYPES, NOTIFY_USER_TYPES | 1.9.0 |
| notify.email.notify_admin| notify.admin_types=email | NOTIFY_EMAIL_ADMIN | NOTIFY_ADMIN_TYPES=email| 1.9.0               |
